...
<div class="modal-footer">
	...
	<button type="button" class="btn btn-sm btn-success py-0 rounded" data-tipetransaksi='<?= $tipetransaksi; ?>' data-iditem='<?= $iditem; ?>'>Edit</button>
	<button type="button" class="btn btn-sm btn-danger py-0 rounded" data-tipetransaksi='<?= $tipetransaksi; ?>' data-iditem='<?= $iditem; ?>'>Hapus</button>
</div>