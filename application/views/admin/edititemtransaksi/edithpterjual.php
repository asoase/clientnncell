  ...
  <div class="modal-body">
    ...
    <div class="formclass my-0">
      <div class="form-group row my-0">
        <label for="formGroupmerk" class="col-4 col-form-label col-form-label-sm">Merk</label>
        <div class="col-8">
      ...
      <div class="form-group row my-0">
        <label for="formGrouptipe" class="col-4 col-form-label col-form-label-sm">Tipe</label>
        <div class="col-8">
      ...
      <div class="form-group row my-0">
        <label for="formGroupimei" class="col-4 col-form-label col-form-label-sm">imei</label>
        <div class="col-8">
      ...
      <div class="form-group row my-0">
        <label for="formGroupram" class="col-4 col-form-label col-form-label-sm">RAM</label>
        <div class="col-8">
      ...
      <div class="form-group row my-0">
        <label for="formGrouprom" class="col-4 col-form-label col-form-label-sm">ROM</label>
        <div class="col-8">
      ...
      <div class="form-group row my-0">
        <label for="formGroupjaringan" class="col-4 col-form-label col-form-label-sm">Jaringan</label>
        <div class="col-8">
      ...
      <div class="form-group row my-0">
        <label for="formGroupgaransi" class="col-4 col-form-label col-form-label-sm">Garansi</label>
        <div class="col-8">
      ...
      <div class="form-group row my-0">
        <label for="formGrouphargaawal" class="col-4 col-form-label col-form-label-sm">Harga Awal</label>
        <div class="col-8">
          <input type="tel" class="inputform inputcurrency form-control form-control-sm" value="<?='Rp. ' . number_format($detailitem['harga_awal'], 2, ',', '.');?>" id="formGrouphargaawal" placeholder="masukkan harga awal" pattern="^(Rp\. )?(?!0)((([0-9]{1,3}\.([0-9]{3}\.)*)[0-9]{3}|[0-9]{1,3})?(,00))$" data-a-sign="Rp. " data-a-dec="," data-a-sep="." data-lZero="deny" data-wEmpty="sign" required>
        </div>
      </div>
      <div class="form-group row my-0">
        <label for="formGrouphargaterjual" class="col-4 col-form-label col-form-label-sm">Terjual</label>
        <div class="col-8">
          <input type="tel" class="inputform inputcurrency form-control form-control-sm" value="<?='Rp. ' . number_format($detailitem['terjual'], 2, ',', '.');?>" id="formGrouphargaterjual" placeholder="masukkan harga terjual" pattern="^(Rp\. )?(?!0)((([0-9]{1,3}\.([0-9]{3}\.)*)[0-9]{3}|[0-9]{1,3})?(,00))$" data-a-sign="Rp. " data-a-dec="," data-a-sep="." data-lZero="deny" data-wEmpty="sign" required>
        </div>
      </div>
      <div class="form-group row my-0">
        <label for="formGroupkelengkapan" class="col-4 col-form-label col-form-label-sm">Kelengkapan</label>
        <div class="col-8">
      ...
      <div class="form-group row my-0">
        <label for="formGroupkerusakan" class="col-4 col-form-label col-form-label-sm">Kerusakan</label>
        <div class="col-8">
      ...
      <div class="form-group row my-0">
        <label for="formGroupsales" class="col-4 col-form-label col-form-label-sm">Sales</label>
        <div class="col-8">
