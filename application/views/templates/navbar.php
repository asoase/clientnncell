    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto headeraktif" data-headeraktif="<?=$headeraktif;?>">
          <li class="nav-item ml-1 border-bottom border-primary">
            <a class="nav-link text-center" href="<?=base_url('beranda');?>">Beranda</a>
          </li>
          <li class="nav-item ml-1 border-bottom border-primary">
            <a class="nav-link text-center" href="<?=base_url('servis');?>">Servis</a>
          </li>
          <li class="nav-item ml-1 border-bottom border-primary">
            <a class="nav-link text-center" href="<?=base_url('admin');?>">Admin</a>
          </li>
        </ul>
      </div>
    </div>
